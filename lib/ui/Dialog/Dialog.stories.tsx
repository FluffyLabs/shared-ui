...
export const Default: Story = {
  ...
  render: () => (
    <div className="bg-accent p-12 max-sm:p-6">
      <Dialog>
        <Dialog.Header>Start with an example program or upload your file</Dialog.Header>
    ...
    <div className="bg-accent p-12 max-sm:p-6">
      <Dialog asChild>
        <div className="rounded-none">
          <Dialog.Header className="rounded-none">Start with an example program or upload your file</Dialog.Header>
